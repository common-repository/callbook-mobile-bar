...
=Now Premium=
The Premium Version now allows to real time **chat** through the most popular instant message apps.

The Premium Version also includes other useful functions for a better user experience and to track buttons clicks.

*Real time chat on Whatsapp
*Real time instant message on Facebook Messenger
*Access to Tablet screen Bar
*Link Button target attribute
*Track Event Google Analytics enable/disable
*Translate string with WPML String Translation

[GO PREMIUM!](https://www.callbookbar.com/?utm_source=free-plugin&utm_medium=banner&utm_campaign=premium)
