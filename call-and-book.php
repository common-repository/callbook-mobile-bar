...
Description: Call&Book Mobile Bar is a plug-in that will help to improve conversion rates for responsive web sites. The main buttons normally used for contact, buy a service/product all in one: an easy and user friendly bar with call to action: call, send email, book. <a target="_blank" href="https://www.callbookbar.com/?utm_source=free-plugin&utm_medium=banner&utm_campaign=premium">Go Premium!</a>
Version: 1.2.2
...
{  
    ...
    echo '</div>';
  	...
  	echo'<div class="cb_powered"><a target="_blank" title="Massimo Salerno" alt="Webdesigner, webdeveloper e esperto wordpress" href="//www.massimosalerno.it">Powered by Massimo Salerno</a></div>';
  }
  else {
...
function callbook_scripts() {
	...
	wp_register_style('headers_font', '//fonts.googleapis.com/css?family='. urlencode(get_option('cb_callbook_font_name')).'', false, null);
