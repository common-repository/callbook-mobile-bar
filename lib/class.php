...
public function settings_section( $section ) {
	...
	//	$html .= '</div>';
			...
			$html .= '<form method="post" action="options.php" enctype="multipart/form-data">' . "\n";
				...
				$html .= '</p>' . "\n";
			$html .= '</form>' . "\n";
			$html .='<a target="_blank" href="https://www.callbookbar.com/?utm_source=free-plugin&utm_medium=banner&utm_campaign=premium"><div class="premiumv" style="position:fixed;top:80px;right:20px"><img src="'.$this->assets_url . 'images/go-p.jpg'.'"></a></div>';
		$html .= '</div>' . "\n";
...
add_action('admin_print_styles', 'dynamic_css_preview');
	...
	<?php
		...
		wp_register_style('headers_font_admin', '//fonts.googleapis.com/css?family='. urlencode(get_option('cb_callbook_font_name')).'', false, null);
